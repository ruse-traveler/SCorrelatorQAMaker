...
namespace SColdQcdCorrelatorAnalysis {
  ...
  void SMakeTrkQATuples::DoTrackLoop(PHCompositeNode* topNode) {
    ...
    for (SvtxTrackMap::Iter itTrk = mapTrks -> begin(); itTrk != mapTrks -> end(); ++itTrk) {
      ...
      m_vecTrackLeaves[15] = (float) genInfo.partons.first.embedID;
      m_vecTrackLeaves[16] = (float) genInfo.partons.first.charge;
      m_vecTrackLeaves[17] = (float) genInfo.partons.first.mass;
      m_vecTrackLeaves[18] = (float) genInfo.partons.first.eta;
      m_vecTrackLeaves[19] = (float) genInfo.partons.first.phi;
      m_vecTrackLeaves[20] = (float) genInfo.partons.first.ene;
      m_vecTrackLeaves[21] = (float) genInfo.partons.first.px;
      m_vecTrackLeaves[22] = (float) genInfo.partons.first.py;
      m_vecTrackLeaves[23] = (float) genInfo.partons.first.pz;
      m_vecTrackLeaves[24] = (float) genInfo.partons.first.pt;
      m_vecTrackLeaves[25] = (float) genInfo.partons.first.vx;
      m_vecTrackLeaves[26] = (float) genInfo.partons.first.vy;
      m_vecTrackLeaves[27] = (float) genInfo.partons.first.vz;
      m_vecTrackLeaves[28] = (float) genInfo.partons.second.pid;
      m_vecTrackLeaves[29] = (float) genInfo.partons.second.status;
      m_vecTrackLeaves[30] = (float) genInfo.partons.second.embedID;
      m_vecTrackLeaves[31] = (float) genInfo.partons.second.charge;
      m_vecTrackLeaves[32] = (float) genInfo.partons.second.mass;
      m_vecTrackLeaves[33] = (float) genInfo.partons.second.eta;
      m_vecTrackLeaves[34] = (float) genInfo.partons.second.phi;
      m_vecTrackLeaves[35] = (float) genInfo.partons.second.ene;
      m_vecTrackLeaves[36] = (float) genInfo.partons.second.px;
      m_vecTrackLeaves[37] = (float) genInfo.partons.second.py;
      m_vecTrackLeaves[38] = (float) genInfo.partons.second.pz;
      m_vecTrackLeaves[39] = (float) genInfo.partons.second.pt;
      m_vecTrackLeaves[40] = (float) genInfo.partons.second.vx;
      m_vecTrackLeaves[41] = (float) genInfo.partons.second.vy;
      m_vecTrackLeaves[42] = (float) genInfo.partons.second.vz;
